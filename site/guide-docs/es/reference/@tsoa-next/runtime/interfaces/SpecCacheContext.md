...
# Interfaz: SpecCacheContext

Definido en: [packages/runtime/src/decorators/specPath.ts:30](https://github.com/tsoa-next/tsoa-next/blob/main/packages/runtime/src/decorators/specPath.ts#L30)

Contexto pasado a caches de respuesta.
