...
---
[tsoa-next](../../packages.md) / @tsoa-next/runtime

Este paquete contiene los ayudantes de tiempo de ejecución `tsoa-next`.

`tsoa-next` continúa el original [`tsoa`](https://github.com/tsoa-next/tsoa-next) proyecto, y este paquete lleva adelante la fundación de tiempo de ejecución establecida allí.

Para la referencia principal README y API, vea:
