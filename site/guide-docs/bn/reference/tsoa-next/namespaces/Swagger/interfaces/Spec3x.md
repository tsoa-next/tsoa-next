...
# ইন্টারফেস: স্পেকট্রাক্স

নির্ধারিত মান: [packages/runtime/src/swagger/swagger.ts:37](https://github.com/tsoa-next/tsoa-next/blob/main/packages/runtime/src/swagger/swagger.ts#L37)

সকল বিষয়ের জন্য বেস ইন্টারফেস OpenAPI X.x নির্ধারিত হয়েছে
সকল 3.x সংস্করণ দ্বারা ভাগ করা হয়েছে
