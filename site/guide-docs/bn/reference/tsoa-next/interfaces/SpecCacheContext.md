...
# ইন্টারফেস: Speconctext

নির্ধারিত মান: [packages/runtime/src/decorators/specPath.ts:30](https://github.com/tsoa-next/tsoa-next/blob/main/packages/runtime/src/decorators/specPath.ts#L30)

কনটেক্সট s-respon ক্যাশেতে পাস করেছে.
