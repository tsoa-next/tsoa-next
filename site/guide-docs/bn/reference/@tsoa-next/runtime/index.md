...
এই প্যাকেজের জন্য সর্বনিম্ন সাহায্য উপস্থিত রয়েছে `tsoa-next`. .

`tsoa-next` মূল বস্তুটি সংরক্ষণ করা হবে [`tsoa`](https://github.com/tsoa-next/tsoa-next) প্রজেক্ট, এবং এই প্যাকেজ সেখানে যে ঢালের ভিত্তি স্থাপন করা হয়েছে তার সামনে।

প্রধান পাঠক এবং API রেফারেন্সের জন্য, দেখুন:
