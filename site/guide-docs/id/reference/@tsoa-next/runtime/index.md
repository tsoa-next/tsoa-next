...
Paket ini berisi pembantu untuk waktu-jalan `tsoa-next`.

`tsoa-next` melanjutkan aslinya [`tsoa`](https://github.com/tsoa-next/tsoa-next) proyek, dan paket ini membawa maju yayasan runtime didirikan di sana.

Untuk referensi README dan API utama, lihat:
