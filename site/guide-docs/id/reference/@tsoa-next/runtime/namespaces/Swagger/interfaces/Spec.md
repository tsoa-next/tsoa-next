...
---
[tsoa-next](../../../../../packages.md) / [@tsoa-next/runtime](../../../index.md) / [Swagger](../index.md) / Spec

# Antarmuka: Spec

Didefinisikan dalam: [packages/runtime/src/swagger/swagger.ts:12](https://github.com/tsoa-next/tsoa-next/blob/main/packages/runtime/src/swagger/swagger.ts#L12)
