...
# इंटरफ़ेस: SpecCacheContext

में परिभाषित: [packages/runtime/src/decorators/specPath.ts:30](https://github.com/tsoa-next/tsoa-next/blob/main/packages/runtime/src/decorators/specPath.ts#L30)

कॉन्टेक्स्ट को स्पेक-रिस्पंस कैश में पारित किया गया।
