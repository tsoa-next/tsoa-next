...
---
[tsoa-next](../../../../packages.md) / [tsoa-next](../../../index.md) / [Swagger](../index.md) / Spec

# इंटरफ़ेस: युक्ति

में परिभाषित: [packages/runtime/src/swagger/swagger.ts:12](https://github.com/tsoa-next/tsoa-next/blob/main/packages/runtime/src/swagger/swagger.ts#L12)
