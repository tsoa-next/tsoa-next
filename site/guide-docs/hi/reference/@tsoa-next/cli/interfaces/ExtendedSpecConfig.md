...
# इंटरफ़ेस: विस्तारितस्पेक्टकॉनफिग

में परिभाषित: [cli/src/api.ts:387](https://github.com/tsoa-next/tsoa-next/blob/main/packages/cli/src/api.ts#L387)

सामान्यीकृत कल्पना-पीढ़ी विन्यास द्वारा वापस लौटे [validateSpecConfig](../functions/validateSpecConfig.md)।
...
में परिभाषित: [cli/src/api.ts:390](https://github.com/tsoa-next/tsoa-next/blob/main/packages/cli/src/api.ts#L390)
...
में परिभाषित: [cli/src/api.ts:388](https://github.com/tsoa-next/tsoa-next/blob/main/packages/cli/src/api.ts#L388)
...
में परिभाषित: [cli/src/api.ts:389](https://github.com/tsoa-next/tsoa-next/blob/main/packages/cli/src/api.ts#L389)
