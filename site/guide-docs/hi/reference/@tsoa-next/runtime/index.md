...
इस पैकेज में रनटाइम सहायक के लिए शामिल हैं `tsoa-next`।

`tsoa-next` मूल जारी [`tsoa`](https://github.com/tsoa-next/tsoa-next) परियोजना, और यह पैकेज वहाँ स्थापित रनटाइम फाउंडेशन को आगे बढ़ाता है।

मुख्य README और API संदर्भ के लिए, देखें:
