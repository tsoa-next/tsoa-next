...
هذه الحزمة تحتوي على مُساعدين في العمل `tsoa-next`.

`tsoa-next` استمر [`tsoa`](https://github.com/tsoa-next/tsoa-next) هذا المشروع، وهذه المجموعة تمضي قدماً في الأساس الذي تم إنشاؤه هناك

وللاطلاع على المرجعين الرئيسيين لنظام README و API، انظر:
