...
# Type Alias: FormDataParameter

```ts
type FormDataParameter = ParameterCommonFields & Swagger2ParameterValue & object;
```

محددة في: [packages/runtime/src/swagger/swagger.ts:152](https://github.com/tsoa-next/tsoa-next/blob/main/packages/runtime/src/swagger/swagger.ts#L152)
