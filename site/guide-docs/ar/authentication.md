...
* The `securityDefinitions` المفتاح `securityName` يجب أن تتأكد من وحدة التوثيق الخاصة بك يجب أن تتطابق تماماً `tsoa-next` لا يحتفظ بأي اسم معين أو في حالة خاصة.
