  ...
  describe('paths', () => {
    ...
    describe('methods', () => {
      ...
      describe('deprecation', () => {
        ...
        const deprecatedSpec = new SpecGenerator31(deprecatedMetadata, getDefaultExtendedOptions()).GetSpec()
        const parameterMetadata = new MetadataGenerator('./fixtures/controllers/parameterController.ts').Generate()
        const parameterSpec = new SpecGenerator31(parameterMetadata, getDefaultExtendedOptions()).GetSpec()
